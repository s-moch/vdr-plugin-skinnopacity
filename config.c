...
void cNopacityConfig::LoadDefaults(void) {
    ...
    conf.insert(std::pair<std::string, int>("displayTitleSubtitle", 0));
    ...
    conf.insert(std::pair<std::string, int>("menuRecordingsDurationMode", 2));
    ...
    conf.insert(std::pair<std::string, int>("menuSchedulesShowProgressBar", 1));
    ...
    conf.insert(std::pair<std::string, int>("displayReplayVolume", 2));
    ...
    conf.insert(std::pair<std::string, int>("replayDisplayPoster", 1));
    conf.insert(std::pair<std::string, int>("replayPosterBorder", 10));
    //DisplayMessage
